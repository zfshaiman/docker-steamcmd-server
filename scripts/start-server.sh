...
if [ ! -f ${SERVER_DIR}/swarm/cfg/server.cfg ]; then
	...
	if wget -q -nc --show-progress --progress=bar:force:noscroll https://raw.githubusercontent.com/ich777/docker-steamcmd-server/alienswarm/config/server.cfg ; then
